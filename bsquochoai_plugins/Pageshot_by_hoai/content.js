var q;
var caidat = {
	filedownloadname: "Pageshot - by bsquochoai -.png",
    ...
    var b = {
        ...
        d = function() {
            ...
            return {
                ...
                U: function(a) {
                    if (a && a.getContext) { //@@ hàm cài đặt canvas ban đầu
                        ...
                        if (c.Ra()) {
                            ...
                            var e = 14 * window.devicePixelRatio; //@@chèn chữ kích thước ở phía trên khung edit 123x1231
                    ...
                    } //@@chèn text ""em hãy chọn vùng cần chụp"" mới bắt đầu
                },
                Wa: N,
                offset: function(a, d) {
    ...
    var g = ka.sa(window).display,
        k = {
            ...
            A: [{
                id: "bsquochoai_save",
                type: "button",
                caption: "Lưu ảnh lên server và copy đường dẫn",
        ...
        g = {
            ...
            A: [{
                id: "caidat",
                type: "button",
                caption: "Cài đặt phần mềm",
                className: "button-caidat"
            }, {
                id: "pencil",
                type: "button",
...
Fa.prototype.i = function(a) {
    ...
    a.lineCap = "round";
    a.strokeStyle = this.p;
	 hinhchunhatmultiply = localStorage.bs_pageshot_HCNsize || 0 //@@ Tool Hinh chu nhat: cài đặt kích thước stroke của hình chữ nhật
    a.lineWidth = this.k * window.devicePixelRatio+Number(hinhchunhatmultiply);
...
q.i = function(a) {
    if ("drawing" !== this.f && "finished" === this.f) {
			bs_fontsizemultiply = localStorage.bs_pageshot_textfontsize || 0
        a.font = this.k * window.devicePixelRatio+Number(bs_fontsizemultiply) + "px " + this.xa;
        a.fillStyle = this.p;
        a.textBaseline = "top";
        //for (var b = this.da.split("\n"), c = 0; c < b.length; c++) a.fillText(b[c], this.T.x, this.T.y + c * this.ya)
		  b = this.da.split("\n")
		  c = b.length-1
		  a.fillText(b[c], this.T.x, this.T.y + c * this.ya)
		  
    }//@@ Tool text: cài đặt text khi đã đánh xong, giờ nó render hình text, a.font là biến font-size
};
q.setStart = function() {};
q.setEnd = function(a) {
    if (a) {
        ...
        this.m = za({
            Aa: b,
            color: this.p,
            width: this.k * window.devicePixelRatio+Number(bs_fontsizemultiply),
            fontFamily: this.xa
        }); //@@ Tool text: cài đặt text khi đánh vào, width là biến font-size
        this.T = a
    }
    this.f = "drawing"
};
...
function Ha(a) {
    ...
    var m = {
        ...
        C = localStorage.bs_pageshot_mainColor || "#ff0000",
        A = localStorage.bs_pageshot_markerColor || "#ffff00",
        B = 0,
        n = null,
        y = new la(a),
        F = [],
    ...
    return {
        $a: N,
        D: function(a) {
            n === m.O ? (A = a, localStorage.bs_pageshot_markerColor = A) : (C = a, localStorage.bs_pageshot_mainColor = C);
            s && s.D(a)
        },
        Q: function() {
            return n === m.O ? A : C
...
var Z = function() {
        ...
        return {
            ...
            upload: function(b) {
                b.dataUrl && ia.Za("upload_scrn_", b, function(b) {
                    chrome.runtime.sendMessage({ //@@Hàm đăng lên server bsquochoai
            ...
            save: function(b) {
                b && chrome.downloads.download({
                    url: b,
                    filename: caidat.filedownloadname
                }, function() {
                    a()
                })
            },
    ...
    Ka = function() {
        ...
        function h(a) {
            switch (a) { //@@Khai báo các tính năng của các nút
                case "close":
                    e();
                    Z.close();
                    break;
                ...
                case "print":
                    m();
                    break;
                case "bsquochoai_save":
                    A("bsquochoai_save");
                    break;
                case "caidat":
                    chrome.tabs.create({url:chrome.runtime.getURL(caidat.pluginfolder+"caidat.html")}, function(){})
                    break;
                case "search_google":
                    A("search_google");
                    break;
        ...
        function A(a) { //@@ hàm A (là hàm upload ảnh, hàm này sẽ gọi hàm B(a), có biến cmdAfterUpload là biến xử lý sau khi đã đăng xong ở file event.js)
            e();
            Z.upload(B(a));
