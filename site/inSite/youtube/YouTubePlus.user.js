    ...
    function particle(isaddon) {
        ...
        function lang(label) {
            ...
            var observer,
                ...
                urlBase = "https://api.github.com/repos/ihatecoccoc/youtube/contents/Locale/";
            if (!parSets.extLang) {
                set("extLang", {});
            }
        ...
        function advancedOptions() {
            ...
            if (window.location.pathname === "/watch" && header && !cnslBtn) {
                ...
                controls.innerHTML = //
                    ...
                    //"    <div id='download-button' class='yt-uix-tooltip' data-p='ttp|CNSL_FRME' data-action='downloadVideo'></div>" +
                    "</div>";
                if (parSets.VID_PLR_ATPL) {
    ...
    function initParticle(event) {
        ...
        if (event) {
            ...
            if (window.chrome || userscript) {
                ...
                holder.href = chrome.extension.getURL('site/inSite/youtube/YouTubePlus.css');
